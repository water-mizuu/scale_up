...
mixin _$Lesson {
 ...
 String get id; String get category; String get name; String get description;@JsonKey(name: "units_type") String get unitsType; List<String> get units; List<Chapter> get chapters;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,category,name,description,unitsType,const DeepCollectionEquality().hash(units),const DeepCollectionEquality().hash(chapters));

@override
String toString() {
  return 'Lesson(id: $id, category: $category, name: $name, description: $description, unitsType: $unitsType, units: $units, chapters: $chapters)';
}
...
@useResult
$Res call({
 String id, String category, String name, String description,@JsonKey(name: "units_type") String unitsType, List<String> units, List<Chapter> chapters
});
...
/// Create a copy of Lesson
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? category = null,Object? name = null,Object? description = null,Object? unitsType = null,Object? units = null,Object? chapters = null,}) {
...
class _Lesson extends Lesson {
  const _Lesson({required this.id, required this.category, required this.name, required this.description, @JsonKey(name: "units_type") required this.unitsType, required final  List<String> units, required final  List<Chapter> chapters}): _units = units,_chapters = chapters,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,category,name,description,unitsType,const DeepCollectionEquality().hash(_units),const DeepCollectionEquality().hash(_chapters));
...
/// Create a copy of Lesson
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? category = null,Object? name = null,Object? description = null,Object? unitsType = null,Object? units = null,Object? chapters = null,}) {
