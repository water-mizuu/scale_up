...
mixin _$Lesson {
 ...
 String get id; String get category; String get name; String get description;@JsonKey(fromJson: colorFromJson, toJson: colorToJson) Color get color; List<String> get units; List<Chapter> get chapters;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Lesson&&(identical(other.id, id) || other.id == id)&&(identical(other.category, category) || other.category == category)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.color, color) || other.color == color)&&const DeepCollectionEquality().equals(other.units, units)&&const DeepCollectionEquality().equals(other.chapters, chapters));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,category,name,description,color,const DeepCollectionEquality().hash(units),const DeepCollectionEquality().hash(chapters));
...
@useResult
$Res call({
 String id, String category, String name, String description,@JsonKey(fromJson: colorFromJson, toJson: colorToJson) Color color, List<String> units, List<Chapter> chapters
});
...
/// Create a copy of Lesson
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? category = null,Object? name = null,Object? description = null,Object? color = null,Object? units = null,Object? chapters = null,}) {
...
class _Lesson extends Lesson {
  const _Lesson({required this.id, required this.category, required this.name, required this.description, @JsonKey(fromJson: colorFromJson, toJson: colorToJson) required this.color, required final  List<String> units, required final  List<Chapter> chapters}): _units = units,_chapters = chapters,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,category,name,description,color,const DeepCollectionEquality().hash(_units),const DeepCollectionEquality().hash(_chapters));
...
/// Create a copy of Lesson
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? category = null,Object? name = null,Object? description = null,Object? color = null,Object? units = null,Object? chapters = null,}) {
