...
// PREAMBLE
import "package:scale_up/data/sources/lessons/lessons_helper/template_node.dart";
// base.dart
...
// GENERATED CODE
final class TemplateParser extends _PegParser<TemplateNode > {
  TemplateParser();
  ...
  TemplateNode ? r0() {
    if (this.pos <= 0) {
      if (this.apply(this.r1) case var templateNode?) {
        if (this.pos >= this.buffer.length) {
          return templateNode;
        }
      }
