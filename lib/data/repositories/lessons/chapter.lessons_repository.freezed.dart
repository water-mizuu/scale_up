...
part of 'chapter.lessons_repository.dart';
...
mixin _$Chapter {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, questionCount, const DeepCollectionEquality().hash(units));
...
abstract mixin class $ChapterCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, @JsonKey(name: "question_count") int questionCount, List<String> units});
}
...
class _Chapter implements Chapter {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, questionCount, const DeepCollectionEquality().hash(_units));
